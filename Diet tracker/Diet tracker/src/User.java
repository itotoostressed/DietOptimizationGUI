...
public class DietGUI extends JFrame {
    ...
    double[] caloriePerServing = {250, 264, 230, 500, 150};
    ...
    public DietGUI() {
        ...
        for (int i = 0; i < numberOfFoods; i++) {
            ...
            maxFood[i] = 1; //sets non negative constraint for the current food
            constraints.add(new LinearConstraint(maxFood, Relationship.LEQ, 5));
            maxFood [i] = 0; //resets the constraints back to all zeros
        }
